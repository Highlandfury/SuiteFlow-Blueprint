...
- `docs/TARGET-STATE-BLUEPRINT.md` v1.14 (PROPOSED): consolidated master index with inventory, architecture summaries, acceptance model (reference pilot + First-Property Deployment Gate), the Programme P0 exit gate and next steps.
...
- Programme reports (separate audit workspace): current state `suiteflow-audit/report.md`; OPERA-level comparison `suiteflow-audit/current-state-and-opera-comparison.md`; actions `p3-gap-matrix.md`; transition `p4-transition-architecture.md`.
