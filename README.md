...
- `docs/TARGET-STATE-BLUEPRINT.md` v1.8 (PROPOSED): consolidated master index with inventory, architecture summaries, acceptance model (reference pilot + First-Property Deployment Gate), the Programme P0 exit gate and next steps.
